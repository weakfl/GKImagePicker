Pod::Spec.new do |s|
  ...
  s.homepage       =  'https://github.com/weakfl/GKImagePicker'
  s.author         =  { 'Georg Kitz' => 'info@aurora-apps.com' }
  s.source         =  { :git => 'https://github.com/weakfl/GKImagePicker.git', :commit => '77e132abc04a02c0cf495a8ee468018ddac5a225' }
